...
class MI_Survey_Questions {
    ...
    private static function get_all_questions() {
        return array(
            'pl' => array(
                'A' => array(
                    'Często “słyszę” w głowie słowa, zanim je przeczytam, powiem lub napiszę, jakbym je wcześniej przećwiczył/a w myślach.',
                    ...
                    'Niedawno napisałem/am coś, z czego jestem szczególnie dumny/a / coś, co zostało docenione przez innych (post, blog, esej, email itp).',
                    ...
                    'Lubię gry i zabawy słowne, takie jak Scrabble, Wordle, krzyżówki czy podobne łamigłówki.',
                    'Łatwiej mi się skupić, kiedy słucham podcastów lub audiobooków niż podczas oglądania filmów czy telewizji',
                    ...
                    'Podczas podróży moją uwagę bardziej przykuwają napisy na znakach i bilbordach niż krajobrazy.',
                ),
                'B' => array(
                    ...
                    'Bez problemu przeliczam w głowie proporcje, na przykład gdy trzeba podwoić albo potroić składniki przepisu lub jakieś wymiary, bez potrzeby zapisywania wyliczeń na kartce.',
                    ...
                    'Lubię sprawdzać różne scenariusze typu „a co, jeśli?” na przykład: „Co się stanie, jeśli zmienię swoją poranną rutynę?"',
                ...
                'D' => array(
                    ...
                    'Znam i rozponaję melodie wielu różnych piosenek lub utworów muzycznych.',
                    'Łatwo wychwytuję, gdy ktoś fałszuje śpiewając lub grając na intrumencie.',
                    'Mam dobry głos — słyszałem/am to od innych albo po prostu czuję się swobodnie, kiedy śpiewam przy ludziach.',
                    'Zwykle potrafię zanucić albo odtworzyć melodię już po jednym – dwóch przesłuchaniach.',
                    ...
                    'Muzyka towarzyszy mi każdego dnia w różnej formie: na przykład przez streaming, radio czy You Tube.',
                ),
                'E' => array(
